class Level2Scene
{
    ...
    CreateLevel2()
    {
        ...
        let restartButton = loadImage("Assets/Images/Level2/RestartButton.png");
        ...
        let obj_restartButton = this.CreateObject(40, 40);
        this.CreateButton(obj_restartButton, restartButton, 100, 100, .1, -1, ["load"], ["Level2"]);
    }
